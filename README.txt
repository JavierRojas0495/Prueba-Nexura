...
El desarrollo tiene JavaScript,PHP,Jquery,SweetAlert,DataTable,Validaciones para campos vacios y numericos
 ...
 Tener en cuenta que para ingresar a la web deben ir a localhost/ nombre de la carpeta (Pruebas-Nexura)  /web
y de ahi ir a alguno de los modulos que deseen realizar seguimiento
 

orreo para poder iniciar la session

Correo: usuariopruebanexura@gmail.com
password: 12345
